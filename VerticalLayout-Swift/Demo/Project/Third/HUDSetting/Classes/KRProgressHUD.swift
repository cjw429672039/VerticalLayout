...
public enum KRProgressHUDMaskType {
    ...
    var maskColor: UIColor {
        ...
        case .black: return UIColor(white: 0, alpha: 0.4)
...
public enum KRProgressHUDStyle {
    ...
    var backgroundColor: UIColor {
        ...
        case .black: return UIColor.black.withAlphaComponent(0.7)
...
extension KRProgressHUD {
    ...
    ///   - size: Image size.
    ///   - message: HUD's message.
    public static func showImage(_ image: UIImage, size: CGSize? = nil, message: String? = nil, isLoading: Bool = false) {
        shared.show(withMessage: message, image: image, imageSize: size, isLoading: isLoading)
    }
